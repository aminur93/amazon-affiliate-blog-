                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <img src="{{asset('storage/post/'.$post->image)}}" alt="" width="150px;">
                            </div>

                            <div class="form-group">
                                <input type="checkbox" id="publish" class="filled-in" name="status" @if($post->status == 1) checked @endif value="1">
