                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($posts as $key=>$post)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('author.post.show',$post->id)}}" class="btn btn-xs btn-info waves-effect">
                                                <i class="material-icons">visibility</i>
                                            </a>
                                            ||
                                            <a href="{{route('author.post.edit',$post->id)}}" class="btn btn-xs btn-into waves-effect">
